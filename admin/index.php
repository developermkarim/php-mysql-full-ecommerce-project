...
<head>
    ...
    <!-- Google Font of Roboto cnd link -->
  <!-- Favicons -->
...
<main>
    ...
    <form method="POST" autocomplete="off" id="full-form">
    ...
    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="username" class="form-control username" id="yourUsername">
  ...
  <div class="mb-3">
    ...
    <input type="password" class="form-control password" name="password" id="exampleInputPassword1">
               ...
               <div class="col-12">
                      <button name="btn" class="btn btn-primary w-100" type="submit">Login</button>
                    </div>
                    <div class="col-12">
